...
# Adiciona a raiz do repositorio ao path para importar os modulos exercicio*.py
...
class Autograder:
    ...
    @staticmethod
    def test_ex1():
        # Teste com notas validas
        output1 = Autograder.capture_output("exercicio1", "Exercicio1", "calcular_media_notas", "8.5\n7.2")
        Autograder.assert_true("media aritmetica: 7.8" in output1.lower() or "media aritmetica: 7.8" in output1.lower(), "Deve calcular a media corretamente")

        # Teste com nota invalida
    ...
    @staticmethod
    def test_ex2():
        # Teste aprovacao (16% de comprometimento)
        output1 = Autograder.capture_output("exercicio2", "Exercicio2", "analisar_credito", "5000\n800")
        Autograder.assert_true("aprovada" in output1.lower(), "Deve aprovar credito dentro do limite")

        # Teste reprovacao (30% de comprometimento)
        output2 = Autograder.capture_output("exercicio2", "Exercicio2", "analisar_credito", "2000\n600")
        Autograder.assert_true("negada" in output2.lower(), "Deve negar credito acima de 20%")
    
    @staticmethod
    def test_ex3():
        # Teste aprovacao (media >= 6.0)
        output1 = Autograder.capture_output("exercicio3", "Exercicio3", "calcular_desempenho_academico", "7.0\n6.5\n8.5")
        Autograder.assert_true("aprovado" in output1.lower(), "Deve aprovar com media >= 6.0")

        # Teste reprovacao (media < 6.0)
        output2 = Autograder.capture_output("exercicio3", "Exercicio3", "calcular_desempenho_academico", "4.0\n5.0\n6.0")
        Autograder.assert_true("reprovado" in output2.lower(), "Deve reprovar com media < 6.0")
    ...
    def test_ex4():
        ...
        Autograder.assert_true("21" in output2, "Deve calcular multiplicacao corretamente")
    ...
    def test_ex5():
        ...
        Autograder.assert_true("nao esta apto" in output2.lower() or "nao esta apto" in output2.lower(), "Deve negar aposentadoria")
    ...
    def test_ex7():
        ...
        # Teste categoria senior
        output3 = Autograder.capture_output("exercicio7", "Exercicio7", "categorizar_nadador", "25")
        Autograder.assert_true("senior" in output3.lower() or "senior" in output3.lower(), "Deve identificar categoria senior")

        # Teste sem categoria
        output4 = Autograder.capture_output("exercicio7", "Exercicio7", "categorizar_nadador", "3")
        Autograder.assert_true("nao possui categoria" in output4.lower() or "nao possui categoria" in output4.lower(), "Deve identificar quando nao ha categoria definida")
    ...
    def capture_output(module_name, class_name, method_name, input_data):
        try:
            ...
            # Capturar saida e simular entrada
